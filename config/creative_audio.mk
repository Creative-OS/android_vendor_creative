...
ALARM_PATH := vendor/creative/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/creative/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/creative/prebuilt/common/media/audio/ringtones
